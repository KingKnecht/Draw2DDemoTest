...
namespace Draw2DControlLibrary
{
    ...
    public partial class ZoomAndPanControl
    {
        ...
        /// </summary>
        public double ExtentWidth => _unScaledExtent.Width * ViewportZoom;

        /// <summary>
        /// The height of the content (with 'ViewportZoom' applied).
        /// </summary>
        public double ExtentHeight => _unScaledExtent.Height * ViewportZoom;
        ...
        /// </summary>
        public double HorizontalOffset => ContentOffsetX * ViewportZoom;

        /// <summary>
        /// The offset of the vertical scrollbar.
        /// </summary>
        public double VerticalOffset => ContentOffsetY * ViewportZoom;
        ...
        public void SetHorizontalOffset(double offset)
        {
            ...
            try
            {
                ...
                ContentOffsetX = offset / ViewportZoom;
        ...
        public void SetVerticalOffset(double offset)
        {
            ...
            {
                _disableScrollOffsetSync = true;
                ContentOffsetY = offset / ViewportZoom;
                DelayedSaveZoom750Miliseconds();
            }
            finally
            {
