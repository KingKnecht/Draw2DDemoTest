...
namespace Draw2D.Core.Utlils.QuadTree
{
    ...
    public class QuadTreeNode<T> where T : Figure
    {
        ...
        private void CreateSubNodes()
        {
            ...
            var halfWidth = m_bounds.Width / 2;
            var halfHeight = m_bounds.Height / 2;

            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(m_bounds.BottomLeft, new Point(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point(m_bounds.Left, m_bounds.Top + halfHeight), new Point(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point(m_bounds.Left + halfWidth, m_bounds.Top), new Point(halfWidth, halfHeight))));
            m_nodes.Add(new QuadTreeNode<T>(new Rectangle(new Point(m_bounds.Left + halfWidth, m_bounds.Top + halfHeight), new Point(halfWidth, halfHeight))));
        }
